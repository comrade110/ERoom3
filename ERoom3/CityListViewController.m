...
- (void)viewDidLoad
{
    ...
    tbView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 320, 480) style:UITableViewStylePlain];
    ...
    if (defaultCity) {
        ...
        if (NSNotFound != defaultSelectionRow) {
            ...
            [tbView scrollToRowAtIndexPath:indexPath atScrollPosition:UITableViewScrollPositionMiddle animated:YES];
