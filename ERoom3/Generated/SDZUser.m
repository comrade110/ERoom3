...
@implementation SDZUser
	@synthesize checkinTimes = _checkinTimes;
	@synthesize grade = _grade;
	@synthesize _id = __id;
	@synthesize identityNo = _identityNo;
	@synthesize lastCheckinTime = _lastCheckinTime;
	...
	+ (SDZUser*) createWithNode: (CXMLNode*) node
	{
	...
	- (id) initWithNode: (CXMLNode*) node {
		...
		{
			self.checkinTimes = [[Soap getNodeValue: node withName: @"checkinTimes"] intValue];
			...
			self.lastCheckinTime = [Soap getNodeValue: node withName: @"lastCheckinTime"];
	...
	- (NSMutableString*) serializeElements
	{
		...
		[s appendFormat: @"<checkinTimes>%@</checkinTimes>", [NSString stringWithFormat: @"%i", self.checkinTimes]];
		...
		if (self.lastCheckinTime != nil) [s appendFormat: @"<lastCheckinTime>%@</lastCheckinTime>", [[self.lastCheckinTime stringByReplacingOccurrencesOfString:@"\"" withString:@"&quot;"] stringByReplacingOccurrencesOfString:@"&" withString:@"&amp;"]];
